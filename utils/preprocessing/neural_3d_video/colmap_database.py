...
# https://github.com/oppo-us-research/SpacetimeGaussians/blob/main/thirdparty/colmap/pre_colmap.py
# which is itself derived from the official COLMAP python scripts (BSD License):
# https://github.com/colmap/colmap/blob/dev/scripts/python/database.py
#
# Lightly adapted for TAD-GS: numpy tostring()/fromstring() replaced with the
# non-deprecated tobytes()/frombuffer() equivalents.
